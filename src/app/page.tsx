...
export default function Home() {
  const { onClickStartButton, userLocation, setUserLocation, isLoading } = useHomePage();
        ...
        <main className="flex flex-col w-full max-w-md mt-4 h-full">
          <div className="flex-1">
            <div className="w-full h-full bg-gray-200">
              <Map center={{ lat: userLocation.latitude, lng: userLocation.longitude }} style={{ width: "100%", height: "100%" }}
                onDrag={onDrag}
              >
